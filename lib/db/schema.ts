...
/** Restaurant bot: one guest row per chat (`id` === `Chat.id`). */
...
/** Dining tables (SQL table name `tables`). */
...
export type RestaurantTable = InferSelectModel<typeof restaurantTables>;

export const reservations = pgTable("reservations", {
  id: integer("id")
    .primaryKey()
    .notNull()
    .default(sql`nextval('reservations_id_seq')`),
